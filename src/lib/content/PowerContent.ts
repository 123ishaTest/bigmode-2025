...
export const powers: Power[] = [
    ...
    },
    {
        ...
        icon: 'powers/weapon-blue.png',
        type: PowerType.Attack,
        baseBonus: 0.175,
        incrementBonus: 0.175,
        maxCount: Infinity,
    },
    {
        id: 'deal-250-damage',
    ...
    },
    {
        ...
        requirement: { type: RequirementType.DamageDealt, amount: 5000 },
        icon: 'powers/weapon-purple.png',
        type: PowerType.Attack,
        baseBonus: 0.6,
        incrementBonus: 0.6,
        maxCount: Infinity,
